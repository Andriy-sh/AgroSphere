...
import { PaymentNotFoundIcon } from '../icons';
import { TaskNotFoundIcon } from '../icons';
  ...
  const contentMap = {
    payment: {
      ...
      description: hasSearchTerm
        ? 'Try adjusting your search criteria or check for typos – there might be a small mistake.'
        : 'There are no payment records in your history yet. Your payment history will appear here once you make your first transaction.',
    },
    tasks: {
      title: hasSearchTerm ? 'No tasks found!' : 'No tasks available',
      description: hasSearchTerm
        ? 'Try adjusting your search criteria or check for typos – there might be a small mistake.'
        : 'There are no tasks in your list yet. Create your first task to get started!',
    },
    clients: {
      title: hasSearchTerm ? 'No clients found!' : 'No clients available',
      description: hasSearchTerm
        ? 'Try adjusting your search criteria or check for typos – there might be a small mistake.'
        : 'There are no clients in your list yet. Add your first client to get started!',
    },
    team: {
      title: hasSearchTerm
      ...
      description: hasSearchTerm
        ? 'Try adjusting your search criteria or check for typos – there might be a small mistake.'
        : 'There are no team members in your list yet. Invite your first team member to get started!',
    },
    lab: {
      title: hasSearchTerm
      ...
      description: hasSearchTerm
        ? 'Try adjusting your search criteria or check for typos – there might be a small mistake.'
        : 'There are no lab results in your list yet. Your first lab results will appear here!',
    },
    custom: {
      title: 'No results found!',
      description:
        'Try adjusting your search or check for typos – there might be a small mistake.',
    },
  };
...
export const NoResultsFound: React.FC<NoResultsFoundProps> = ({
  ...
  const defaultContent = getDefaultContent(variant, hasSearchTerm);
