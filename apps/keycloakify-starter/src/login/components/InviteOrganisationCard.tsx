                ...
                <div key={idx} className="flex gap-2 justify-between flex-col">
                    ...
                    <div className="flex-1 flex items-center gap-2">
                        <input
                            ...
                            className="w-full rounded-lg border border-[#E5E7EB] px-4 py-1.5 text-base font-medium text-[#101010]  focus:outline-none"
                        />
                        <button
                            type="button"
                            className="bg-[#F1F3F9] rounded-lg w-9 h-9 flex items-center justify-center ml-2"
                        >
