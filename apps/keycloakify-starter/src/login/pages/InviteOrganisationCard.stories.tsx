...
const { KcPageStory } = createKcPageStory({ pageId: "invite-org.ftl" });

const meta = {
    title: "login/invite-org.ftl",
...
export const ValidFarmerInvite: Story = {
    render: () => {
        useEffect(() => {
...
export const ValidAdvisorInvite: Story = {
    render: () => {
        useEffect(() => {
...
export const ValidContractorInvite: Story = {
    render: () => {
        useEffect(() => {
